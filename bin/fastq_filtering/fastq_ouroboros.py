#!/usr/bin/env python
# this script will continuously launch snakemakes to clean, filter and run host depletion on paired end fastq files
import os
import glob
import time
import argparse
...
parser = argparse.ArgumentParser(description='Searching for Pathogens - SEPATH - script to run quality trimming/host depletion on paired end fastq input')
