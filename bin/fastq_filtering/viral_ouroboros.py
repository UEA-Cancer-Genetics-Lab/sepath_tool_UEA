...
while x<len(input_files):
	...
	launchsnake = ('bsub -J viral_SEPATH -q long-eth -M 10000 -R "rusage[mem=10000]" "snakemake -s viral_SEPATH.snake --config outdir=%s input_bam=%s --cluster \\"bsub -q {params.queue} {params.cluster}\\" --jobs 20 --latency-wait 1200 --timestamp"' %(outdir, bamfile))
